...
if __name__ == '__main__':
    ...
    parser.add_argument("--parse_model_name", type=str, default="gpt-4-1106-preview")
    ...
    for idx, prompt in enumerate(tqdm(data)):
        ...
        results, _, price = prompt_chatgpt("You are a helpful assistant.", index=idx, save_path=output_file,
                                           user_input=prompt, model_name=args.parse_model_name, temperature=args.temperature)
        total_price += price
