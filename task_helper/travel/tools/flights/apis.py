...
def _default_flights_path() -> Path:
    return travel_dataset_root() / "database" / "flights" / "clean_Flights_2022.csv"


class Flights:

    def __init__(self, path=None):
        self.path = Path(path) if path else _default_flights_path()
        self.data = None
